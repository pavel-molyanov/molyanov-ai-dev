...
<!-- LLM: Read .claude/skills/project-knowledge/guides/deployment.md and fill deployment info:
...
<!-- LLM: Read .claude/skills/project-knowledge/guides/deployment.md and list required GitHub Secrets.
...
<!-- LLM: Read .claude/skills/project-knowledge/guides/deployment.md and suggest appropriate deployment strategy.
...
<!-- LLM: Read .claude/skills/project-knowledge/guides/deployment.md and suggest monitoring setup.
...
<!-- LLM: Read .claude/skills/project-knowledge/guides/deployment.md for rollback procedures.
