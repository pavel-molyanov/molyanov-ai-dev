---
name: claude-command-new-tech-spec
description: Converted Codex workflow from Claude slash command `new-tech-spec`. Use when the user asks to run the equivalent command or describes this workflow.
---

# Converted Command Workflow: new-tech-spec

Generated from `~/.claude/commands/new-tech-spec.md`.
