---
name: claude-agent-task-creator
description: Converted Codex role prompt from Claude agent `task-creator`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: task-creator

Generated from `~/.claude/agents/task-creator.md`.
