---
name: claude-agent-skill-checker
description: Converted Codex role prompt from Claude agent `skill-checker`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: skill-checker

Generated from `~/.claude/agents/skill-checker.md`.
