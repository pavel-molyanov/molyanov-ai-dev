---
name: claude-agent-reality-checker
description: Converted Codex role prompt from Claude agent `reality-checker`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: reality-checker

Generated from `~/.claude/agents/reality-checker.md`.
