---
name: claude-agent-tech-spec-validator
description: Converted Codex role prompt from Claude agent `tech-spec-validator`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: tech-spec-validator

Generated from `~/.claude/agents/tech-spec-validator.md`.
