...
For simple, one-off tasks — use spawn_agent with built-in subagent types:
...
The orchestrator calls spawn_agent with arbitrary prompt and `subagent_type`. No agent file needed.
