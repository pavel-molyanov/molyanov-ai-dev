---
name: claude-agent-task-validator-coarse
description: Converted Codex role prompt from Claude agent `task-validator-coarse`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: task-validator-coarse

Generated from `~/.claude/agents/task-validator-coarse.md`.
