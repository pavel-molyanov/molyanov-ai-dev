---
name: claude-agent-skeptic
description: Converted Codex role prompt from Claude agent `skeptic`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: skeptic

Generated from `~/.claude/agents/skeptic.md`.
