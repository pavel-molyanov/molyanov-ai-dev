---
name: claude-agent-interview-completeness-checker
description: Converted Codex role prompt from Claude agent `interview-completeness-checker`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---
