---
name: claude-agent-tech-spec-validator-coarse
description: Converted Codex role prompt from Claude agent `tech-spec-validator-coarse`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: tech-spec-validator-coarse

Generated from `~/.claude/agents/tech-spec-validator-coarse.md`.
