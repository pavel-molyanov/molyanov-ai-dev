---
name: claude-command-write-code
description: Converted Codex workflow from Claude slash command `write-code`. Use when the user asks to run the equivalent command or describes this workflow.
---

# Converted Command Workflow: write-code

Generated from `~/.claude/commands/write-code.md`.
