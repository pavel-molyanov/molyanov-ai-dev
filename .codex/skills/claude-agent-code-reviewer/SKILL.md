---
name: claude-agent-code-reviewer
description: Converted Codex role prompt from Claude agent `code-reviewer`. Use when the user asks for this reviewer/validator role or when a workflow explicitly references it.
---

# Converted Role: code-reviewer

Generated from `~/.claude/agents/code-reviewer.md`.
