---
name: claude-command-decompose-tech-spec
description: Converted Codex workflow from Claude slash command `decompose-tech-spec`. Use when the user asks to run the equivalent command or describes this workflow.
---

# Converted Command Workflow: decompose-tech-spec

Generated from `~/.claude/commands/decompose-tech-spec.md`.
