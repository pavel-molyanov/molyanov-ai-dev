---
name: claude-command-decompose-tech-spec-coarse
description: Converted Codex workflow from Claude slash command `decompose-tech-spec-coarse`. Use when the user asks to run the equivalent command or describes this workflow.
---

# Converted Command Workflow: decompose-tech-spec-coarse

Generated from `~/.claude/commands/decompose-tech-spec-coarse.md`.
